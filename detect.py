...
from utils.datasetsCustom import LoadStreams, LoadImages
...
def detect(save_img=False):
    ...
    if classify:
        ...
        modelc.load_state_dict(torch.load('weights/resnet101.pt', map_location=device)['detectModel']).to(device).eval()
